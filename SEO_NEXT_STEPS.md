...
- Production URL: `https://getsayso.netlify.app/`
- Sitemap URL: `https://getsayso.netlify.app/sitemap.xml`
- Robots URL: `https://getsayso.netlify.app/robots.txt`
...
1. Add `https://getsayso.netlify.app/` as a URL-prefix property.
2. Verify ownership through Netlify using the HTML file or meta-tag verification method.
3. Submit `https://getsayso.netlify.app/sitemap.xml`.
4. Request indexing for:
   - `https://getsayso.netlify.app/`
   - `https://getsayso.netlify.app/hands-free-task-manager/`
   - `https://getsayso.netlify.app/voice-task-manager-iphone/`
   - `https://getsayso.netlify.app/youtube-to-checklist/`
   - `https://getsayso.netlify.app/recipe-task-app/`
...
5. Update every canonical URL, Open Graph URL, sitemap URL, and robots sitemap URL from `https://getsayso.netlify.app/` to the new domain.
